      ...
      <div className="relative w-full max-w-sm rounded-3xl border border-beige-200 bg-white/95 p-6 shadow-[0_24px_64px_rgba(0,0,0,0.18)] backdrop-blur-md animate-scale-in">
        ...
        {hasCredits ? (
          <>
            ...
            {/* Credits restants */}
            <div className="my-4 flex items-center justify-center gap-2 rounded-2xl border border-beige-100 bg-beige-50 py-3">
              ...
              <span className="text-xs text-neutral-400">— 1 sera utilise</span>
            </div>

            <p className="mb-5 text-center text-xs text-neutral-400">
              Vos credits sont recharges automatiquement chaque mois.
            </p>
          ...
          <>
            ...
            <p className="mb-4 text-center text-sm text-neutral-500">
              Vous avez utilise tous vos credits ce mois-ci. Ils se rechargent automatiquement chaque mois.
            </p>
